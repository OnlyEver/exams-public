...
Let’s dive into the mechanics of keeping a human being alive, how we measure it, and what it means when the numbers go wrong.
...
*   **A normal adult resting heart rate is between 60 and 100 [beats per minute](https://en.wikipedia.org/wiki/Heart_rate).** 
*   However, babies are tiny, high-revving engines: **A normal resting heart rate for a newborn ranges from 110 to 160 beats per minute.**
...
## Part 2: The Diagnostic Readout (Laboratory Values)

While vital signs tell us *how* the engine is running, laboratory values tell us *what* is running through it. When you get lab results back, you are comparing the patient's values to normal values. 

> **The Critical Value Alert:**
> A **critical laboratory value** represents a test result significantly outside the normal range requiring immediate provider notification. This isn't a "chart it and wait for rounds" situation. This is a "call the doctor right now" situation.
...
## Part 3: The Art and Science of Venipuncture

It does no good to understand lab values if you ruin the blood sample before it gets to the laboratory. [Venipuncture](https://en.wikipedia.org/wiki/Venipuncture) is a highly precise physical procedure. 

### 1. Preparation and Patient Safety
Before you ever uncap a needle:
1.  **Verify Identity:** **The practical nurse must verify the patient's identity using two unique identifiers prior to performing a venipuncture.**
...
*   **Applying direct pressure to a venipuncture site immediately after needle removal prevents [hematoma](https://en.wikipedia.org/wiki/Hematoma) formation.** 
*   If a hematoma (a pooling of blood under the skin) starts forming *during* the draw, **it requires immediate removal of the needle and application of firm pressure.**
*   Watch the site in the days following. **[Phlebitis](https://en.wikipedia.org/wiki/Phlebitis) presents as localized redness and swelling along the course of a punctured vein.** This indicates [inflammation](https://en.wikipedia.org/wiki/Inflammation) of the vein wall.

---

### Final Thoughts for the NCLEX
As you review this material, don't just flashcard the numbers. Visualize the patient. If the blood pressure drops when they stand (orthostatic hypotension), see the gravity pulling the fluid down and the vessels failing to constrict. If the lab calls with a high potassium, picture the electrical chaos in the heart, but also ask yourself: *"Did I leave the tourniquet on too long? Did I shake the tube and cause hemolysis?"*

You are the detective, the mechanic, and the guardian of the human engine. Learn these numbers, master these mechanics, and you will be an outstanding nurse. Good luck!