...
## 1. The Pre-Flight Check: Assessing Mobility and Strength
...
## 3. The Antidote to Gravity: [Nursing](https://en.wikipedia.org/wiki/Nursing) Interventions
...
## 5. Safely Launching the Ship: Client Transfers
...
* Crucially, **the nurse must lock the wheels of the bed before transferring a client**, AND **the nurse must lock the wheels of the wheelchair before transferring a client.** If you skip this, [Isaac Newton](https://en.wikipedia.org/wiki/Isaac_Newton)’s [laws of motion](https://en.wikipedia.org/wiki/Newton%27s_laws_of_motion) will push the bed and chair apart, and your patient will end up on the floor.
...
* **The Sequence:**
  ...
  3. **After stepping with the affected leg, the client steps forward past the cane with the unaffected leg.**
...
| Gait Type | The Mechanics | Weight-Bearing Required |
| :--- | :--- | :--- |
...
* **Ascending (Going UP):**
  1. **When ascending stairs with crutches, the client places the unaffected leg onto the upper step first.** (The strong leg powers the lift).
  2. **After the unaffected leg is on the upper step, the client moves the crutches up to the upper step.**
  3. **After the unaffected leg is on the upper step, the client moves the affected leg up to the upper step.**

* **Descending (Going DOWN):**
  1. **When descending stairs with crutches, the client places the crutches onto the lower step first.** (Creating a safe landing pad).
  2. **After the crutches are on the lower step, the client moves the affected leg onto the lower step.**
  3. **After the affected leg is on the lower step, the client moves the unaffected leg onto the lower step.**

---

### Conclusion
Understanding mobility isn't just about memorizing rules; it's about understanding the physics of the human machine. Keep the body moving when possible, protect its structural integrity when it's stationary, and always use your [mechanical advantages](https://en.wikipedia.org/wiki/Mechanical_advantage) when transferring or utilizing devices. Master these principles, and you'll keep your patients safe, strong, and walking out the [hospital](https://en.wikipedia.org/wiki/Hospital) doors!