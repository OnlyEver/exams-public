...
When we start reading, we don't immediately see the grand architecture. We just see the little pieces. We call these **key details**. By definition, **key details are specific pieces of information found within a literary text**. Think of them like the [bricks](https://en.wikipedia.org/wiki/Brick) of a house. On their own, they might just seem like trivial facts—the color of a character's coat, the weather outside, a stray line of [dialogue](https://en.wikipedia.org/wiki/Dialogue). But when you put them together, **key details provide foundational support for the main idea of a literary text**.

Now, once you have your main idea, you can start looking for the deeper meaning. Why did the author build this house in the first place? Here is where we distinguish between two concepts that people confuse all the time: the *[theme](https://en.wikipedia.org/wiki/Theme_%28narrative%29)* and the *[moral](https://en.wikipedia.org/wiki/Moral)*.
...
### Proving Your Point: Textual Evidence
In [science](https://en.wikipedia.org/wiki/Science), if you make a claim about how an [electron](https://en.wikipedia.org/wiki/Electron) behaves, you better have the [math](https://en.wikipedia.org/wiki/Mathematics) to back it up. In literature, it’s the exact same principle, but your math is the text itself. **Textual evidence is strictly required to validate assertions made about literary elements.** If you say a character is [jealous](https://en.wikipedia.org/wiki/Jealousy), prove it! 

**Textual evidence consists of [exact words](https://en.wikipedia.org/wiki/Quotation) pulled directly from a literary text.** When you are presenting this evidence, you have two primary tools at your disposal:
1.  **[Direct Quotations](https://en.wikipedia.org/wiki/Quotation):** Sometimes the author's exact phrasing is too perfect to mess with. **Direct quotations require [quotation marks](https://en.wikipedia.org/wiki/Quotation_mark) to indicate exact wording taken from a text.**
2.  **[Paraphrasing](https://en.wikipedia.org/wiki/Paraphrase):** Other times, you want to synthesize the idea smoothly. **Paraphrasing involves restating textual evidence using the reader's own [vocabulary](https://en.wikipedia.org/wiki/Vocabulary).**

***

## The Stage and the Struggle: Setting and Conflict

Every great [experiment](https://en.wikipedia.org/wiki/Experiment) requires a [laboratory](https://en.wikipedia.org/wiki/Laboratory). In literature, this laboratory is the [setting](https://en.wikipedia.org/wiki/Setting_%28narrative%29). It’s not just a painted backdrop; it actively shapes the narrative. 

*   **The setting of a literary text establishes the [physical location](https://en.wikipedia.org/wiki/Location_%28geography%29) of the narrative.** (Are we in a [desert](https://en.wikipedia.org/wiki/Desert)? A [spaceship](https://en.wikipedia.org/wiki/Spacecraft)? A crowded [subway](https://en.wikipedia.org/wiki/Rapid_transit)?)
*   **The setting of a literary text establishes the [historical time period](https://en.wikipedia.org/wiki/History) of the narrative.** ([1920s Jazz Age](https://en.wikipedia.org/wiki/Jazz_Age)? The distant future?)
*   **The setting of a literary text encompasses the [social environment](https://en.wikipedia.org/wiki/Social_environment) of the narrative.** (What are the [cultural norms](https://en.wikipedia.org/wiki/Social_norm), [wealth disparities](https://en.wikipedia.org/wiki/Economic_inequality), and social expectations?)

Sometimes, the setting itself is the thing trying to crush our [heroes](https://en.wikipedia.org/wiki/Hero)! **A hostile physical setting can serve as the primary source of conflict in a narrative.** 

Which brings us to the engine that drives every story ever written: **[conflict](https://en.wikipedia.org/wiki/Conflict_%28narrative%29)**. Without it, you just have a boring [diary](https://en.wikipedia.org/wiki/Diary) entry of a very nice day. **A literary conflict is a direct struggle between opposing forces in a narrative.** We can split these struggles into two distinct realms:

| Conflict Realm | Definition | Sub-Types & Examples |
| :--- | :--- | :--- |
| **[Internal Conflict](https://en.wikipedia.org/wiki/Conflict_%28narrative%29%23Internal_conflict)** | **An internal conflict occurs entirely within a single character's mind.** | A character wrestling with their own [guilt](https://en.wikipedia.org/wiki/Guilt_%28emotion%29), [fear](https://en.wikipedia.org/wiki/Fear), or difficult moral choices. |
| **[External Conflict](https://en.wikipedia.org/wiki/Conflict_%28narrative%29%23External_conflict)** | **An external conflict involves a character struggling against an outside force.** | **[Character versus character](https://en.wikipedia.org/wiki/Conflict_%28narrative%29%23Man_versus_man) is an external conflict involving a struggle between two individuals.** ([Batman](https://en.wikipedia.org/wiki/Batman) vs. [The Joker](https://en.wikipedia.org/wiki/Joker_%28character%29))<br><br>**[Character versus nature](https://en.wikipedia.org/wiki/Conflict_%28narrative%29%23Man_versus_nature) is an external conflict pitting a character against environmental forces.** (A sailor surviving a [hurricane](https://en.wikipedia.org/wiki/Tropical_cyclone))<br><br>**[Character versus society](https://en.wikipedia.org/wiki/Conflict_%28narrative%29%23Man_versus_society) is an external conflict pitting a character against cultural norms.** (A rebel fighting a [dystopian government](https://en.wikipedia.org/wiki/Dystopia)) |

***

## The Architecture of Action: Plot

So, we have our setting, and we have our conflict. Now we need things to actually *happen*. 
...
## The People in the Machine: Characterization

A plot is useless without someone to experience it. Let's talk about the players on the [stage](https://en.wikipedia.org/wiki/Stage_%28theatre%29). 

**The [protagonist](https://en.wikipedia.org/wiki/Protagonist) acts as the primary focal character of a literary text.** Notice I didn't say "the good guy." Sometimes the protagonist is a deeply flawed person, but they are the lens through which we experience the story. 
...
## Reading Between the Lines: Explicit vs. Implicit Inferences

This brings us to the ultimate skill in [reading comprehension](https://en.wikipedia.org/wiki/Reading_comprehension): making [inferences](https://en.wikipedia.org/wiki/Inference). To do this, we must understand the dual nature of information.

**[Explicit information](https://en.wikipedia.org/wiki/Explicit_knowledge) is stated directly and unambiguously in the literal text**. If the text says, "The sky was filled with dark, churning [clouds](https://en.wikipedia.org/wiki/Cloud)," that is explicit. There is no guesswork involved.
...
And there you have it! The next time you open a [book](https://en.wikipedia.org/wiki/Book), don't just let the words wash over you. Look for the key details, trace the Freytag Pyramid, feel the friction of the conflict, and read between the lines to uncover the implicit truths. When you understand the architecture of literature, the magic doesn't disappear—it actually becomes far more beautiful!