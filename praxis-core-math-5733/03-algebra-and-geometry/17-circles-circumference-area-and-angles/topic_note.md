# The Geometry of the Perfect Curve: Mastering Circles
...
## The Anatomy of a Circle: Lines, Segments, and Slices

To understand a circle, you must know the names of the lines that interact with it. Let's break down the cast of characters, from the insiders to the outsiders.

### The Insiders: Radii, Diameters, and Chords
...
**Warning for the Exam!** [Order of operations](https://en.wikipedia.org/wiki/Order_of_operations) is paramount here. **The radius must be mathematically [squared](https://en.wikipedia.org/wiki/Square_%28algebra%29) before [multiplying](https://en.wikipedia.org/wiki/Multiplication) by pi when calculating the area of a circle.** 
If your radius is 3, you do *not* multiply 3 by 3.14 and then square the result. You square the 3 to get 9, and *then* you multiply 9 by $\pi$ to get $9\pi$ (or about 28.26). 
...
Let's combine what we've learned into one of the most stunning [geometric proofs](https://en.wikipedia.org/wiki/Mathematical_proof). We know that a semicircle's arc is $180^\circ$. We also know that an inscribed angle is exactly *half* of the arc it intercepts. 

What happens if you draw an inscribed angle that intercepts a perfect semicircle? 
Half of $180^\circ$ is $90^\circ$. And **a [right angle](https://en.wikipedia.org/wiki/Right_angle) measures exactly [90 degrees](https://en.wikipedia.org/wiki/Degree_%28angle%29)**. 
