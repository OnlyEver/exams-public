# The Geometry of Space: Mastering the [Volume](https://en.wikipedia.org/wiki/Volume) of Rectangular Prisms

Hello there! Let’s talk about boxes. Ordinary, everyday shipping boxes, [swimming pools](https://en.wikipedia.org/wiki/Swimming_pool), cereal cartons, and [fish tanks](https://en.wikipedia.org/wiki/Aquarium). 
...
> **What is it?** A **rectangular prism** is a [three-dimensional](https://en.wikipedia.org/wiki/Three-dimensional_space) solid object with six rectangular faces. 

Imagine picking up a [brick](https://en.wikipedia.org/wiki/Brick). Turn it around in your hands. Count the flat surfaces. Top, bottom, front, back, left, right—that is exactly **6 faces**. 
...
*   **Volume:** This is the *stuffing*. **[Volume](https://en.wikipedia.org/wiki/Volume)** measures the amount of three-dimensional space enclosed by a boundary. It is the interior space of a prism.
*   **Capacity:** When you look at [math word problems](https://en.wikipedia.org/wiki/Word_problem_%28mathematics_education%29), you will often see the word "capacity." Do not let this throw you. The term **[capacity](https://en.wikipedia.org/wiki/Volume)** simply refers to the maximum interior volume a container can hold. If volume is the space, capacity is the promise of how much [water](https://en.wikipedia.org/wiki/Water), [sand](https://en.wikipedia.org/wiki/Sand), or [air](https://en.wikipedia.org/wiki/Atmosphere_of_Earth) can fit into that space!

Because volume measures three-dimensional space, **volume is always expressed in cubic units**. Think of a cubic unit as a tiny, perfectly square building block—like a single [Lego brick](https://en.wikipedia.org/wiki/Lego). When we calculate volume, we are simply asking: *"How many of these tiny cubes can I pack into this box without leaving any empty space?"*

Common cubic units you will see on the Praxis exam include **cubic centimeters**, **[cubic meters](https://en.wikipedia.org/wiki/Cubic_metre)**, and **cubic inches**.
...
| :--- | :--- | :--- |
| **[Imperial Volume](https://en.wikipedia.org/wiki/Imperial_units)** | **One cubic yard is equal to 27 [cubic feet](https://en.wikipedia.org/wiki/Cubic_foot).** | 1 yard = 3 feet. <br> $3 \times 3 \times 3 = 27$ |
| **Imperial Volume** | **One cubic foot is equal to 1728 cubic inches.** | 1 foot = 12 inches. <br> $12 \times 12 \times 12 = 1728$ |
| **[Metric Volume](https://en.wikipedia.org/wiki/Metric_system)** | **One [cubic meter](https://en.wikipedia.org/wiki/Cubic_metre) is equal to one million cubic centimeters.** | 1 meter = 100 cm. <br> $100 \times 100 \times 100 = 1,000,000$ |
...
If you take a tiny hollow cube that is exactly 1 centimeter on each side (1 cubic centimeter), and you fill it with water, the amount of water it holds is exactly one [milliliter](https://en.wikipedia.org/wiki/Litre). 
...
Imagine you are loading [cargo](https://en.wikipedia.org/wiki/Cargo) onto a ship. You don't calculate the volume of the entire cargo hold by measuring every single individual box at once. If all the boxes are exactly the same size, you take a shortcut. 
...
*   Marvel at the fact that a **[milliliter](https://en.wikipedia.org/wiki/Litre) is exactly a cubic centimeter**, bridging the liquid and solid worlds.
