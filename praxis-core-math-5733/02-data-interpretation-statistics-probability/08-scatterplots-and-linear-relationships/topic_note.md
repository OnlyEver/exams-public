...
Once you've plotted all your data points, you step back and look at the whole picture. The dots are scattered everywhere. But are they *completely* random, or is there a pattern? 

We are looking for a **linear relationship**. **A linear relationship exists when the points on a scatterplot roughly form a straight line.**
...
| **No Relationship** | Variables do not affect each other. | **Randomly distributed** | Shoe size vs. IQ |
