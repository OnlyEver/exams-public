...
## The Machine’s Voice: Alarms and Parameters

Alarms are the way medical equipment talks to you. They say, "Hey! The [physiology](https://en.wikipedia.org/wiki/Physiology) is drifting from the baseline!" or "Hey! My tube is kinked!" 

To make sure the machine is speaking the truth, **nurses must ensure equipment alarm parameters match the client's current prescribed clinical limits.** If your patient is a healthy athlete with a [resting heart rate](https://en.wikipedia.org/wiki/Heart_rate) of 55, and the alarm is set to trigger at 60, it will beep all night. But here is the cardinal, unbreakable rule of nursing:

> **Disabling medical equipment alarms is strictly prohibited.** 
...
[Oxygen](https://en.wikipedia.org/wiki/Oxygen) is life, but in the presence of a spark, it accelerates fire with terrifying speed. We prescribe [oxygen therapy](https://en.wikipedia.org/wiki/Oxygen_therapy) for patients to use at home, but we have to treat it like a controlled explosive. 
...
1.  **Malfunctioning medical equipment must be immediately removed from the client care area.** Do not leave it in the room for someone else to accidentally plug in! 
2.  **The nurse must attach a descriptive defect tag to any malfunctioning piece of equipment.** Don't just write "broken." Write "Screen blanks out when bed is raised." Be specific.
3.  **The nurse must explicitly notify the [biomedical engineering](https://en.wikipedia.org/wiki/Biomedical_engineering) department regarding any malfunctioning equipment.** They are the hospital's equipment detectives and fixers.

### The Forensics of Failure: Documentation and Law
