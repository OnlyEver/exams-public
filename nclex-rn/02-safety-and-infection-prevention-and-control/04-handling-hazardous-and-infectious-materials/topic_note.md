...
Welcome, future [nurses](https://en.wikipedia.org/wiki/Nurse). When you walk onto a [hospital](https://en.wikipedia.org/wiki/Hospital) floor, you might look around and see monitors, beds, and medication carts. But I want you to look closer. I want you to see the *[physics](https://en.wikipedia.org/wiki/Physics)* and the *[biology](https://en.wikipedia.org/wiki/Biology)* happening right under your nose. A healthcare setting is essentially a tightly controlled high-energy physics laboratory and a [biological containment](https://en.wikipedia.org/wiki/Biocontainment) zone all rolled into one. 

Today, we are going to master the [science](https://en.wikipedia.org/wiki/Science) of **hazardous and infectious materials**. We aren’t just memorizing rules; we are understanding *why* the physical world behaves the way it does so you can anticipate the danger before it happens. 

Let’s dive into the fascinating, invisible [forces](https://en.wikipedia.org/wiki/Force) you'll be managing every single shift.
...
Before the patient even arrives, two critical items must be in the room:
1.  **A specialized lead-lined container must be kept inside the room of any patient receiving internal radiation therapy.** (Often called a "lead pig").
2.  **Long-handled [forceps](https://en.wikipedia.org/wiki/Forceps) must be kept readily available in the room.**

**Long-handled forceps are utilized to safely retrieve an internal radiation implant in the event of dislodgement.** Notice the design: *long-handled*. This utilizes our "Distance" principle to keep the radiation away from your hands. 
