Welcome to the magnificent machinery of the [human body](https://en.wikipedia.org/wiki/Human_body)! [Nursing](https://en.wikipedia.org/wiki/Nursing) is not about simply memorizing a list of arbitrary tasks; it is the fine art of clinical detection. When you walk into a patient's room, you aren't just looking at a person—you are observing a complex, interconnected universe of pumps, pipes, electrical circuits, and [gas-exchange](https://en.wikipedia.org/wiki/Gas_exchange) bellows. 

Our job is to detect the subtle whispers of a system failing before it starts shouting. **Early identification of patient deterioration requires prompt notification of the [primary healthcare provider](https://en.wikipedia.org/wiki/Primary_care_physician).** But before you can call for help, you have to know exactly what you are looking at. 
...
## 2. The Pump and the Pipes: Cardiovascular & Hemodynamics
...
If a patient is bedridden, gravity pulls fluid to their backside, not their feet. Therefore, **pitting edema over the [sacrum](https://en.wikipedia.org/wiki/Sacrum) in a bedridden patient indicates systemic fluid volume overload.** 
...
## 3. The Bellows: Respiratory Assessments
...
* **E** (the second one) stands for **[ecchymosis](https://en.wikipedia.org/wiki/Ecchymosis)** (bruising).
...
To heal a wound, the body needs protein. **[Serum albumin](https://en.wikipedia.org/wiki/Serum_albumin) levels are used to assess long-term nutritional status related to wound healing.** 
...
## 6. The Intake and Output: Gastrointestinal Assessments

Finally, we assess the [gut](https://en.wikipedia.org/wiki/Gastrointestinal_tract). 
