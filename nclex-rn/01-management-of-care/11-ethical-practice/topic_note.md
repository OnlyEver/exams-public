# The Beautiful, Messy Science of Doing What’s Right: [Bioethics](https://en.wikipedia.org/wiki/Bioethics) in [Nursing](https://en.wikipedia.org/wiki/Nursing)

If you think [physiology](https://en.wikipedia.org/wiki/Physiology) is complicated, just wait until you have to deal with a [human being's](https://en.wikipedia.org/wiki/Human) choices. 
...
## The Big Six: The [Fundamental Forces](https://en.wikipedia.org/wiki/Fundamental_interaction) of [Nursing Ethics](https://en.wikipedia.org/wiki/Nursing_ethics)

In [physics](https://en.wikipedia.org/wiki/Physics), you have forces like [gravity](https://en.wikipedia.org/wiki/Gravity) and [electromagnetism](https://en.wikipedia.org/wiki/Electromagnetism). In nursing, you have six ethical principles governing how we interact with our patients. You need to know these inside and out.
...
## When Principles Collide: The Anatomy of an [Ethical Dilemma](https://en.wikipedia.org/wiki/Ethical_dilemma)

So, what happens when these "forces" push in opposite directions? You get [friction](https://en.wikipedia.org/wiki/Friction). In our world, **an [ethical dilemma](https://en.wikipedia.org/wiki/Ethical_dilemma) occurs when a [conflict](https://en.wikipedia.org/wiki/Conflict_%28psychology%29) exists between two or more ethical principles.** 
...
If you think, *"I know better than them, I'm going to sneak the blood in anyway because it will save them,"* you have just crossed a massive ethical line. **[Paternalism](https://en.wikipedia.org/wiki/Paternalism) occurs when a healthcare provider makes decisions for a client without client [consent](https://en.wikipedia.org/wiki/Consent).** 

> ⚠️ **The [Golden Rule](https://en.wikipedia.org/wiki/Golden_Rule) of Paternalism:** Never do it. Fundamentally, **paternalism violates the ethical principle of autonomy.** 

Instead of acting like a paternalistic [dictator](https://en.wikipedia.org/wiki/Dictator), your role is to be a shield. **Nursing [advocacy](https://en.wikipedia.org/wiki/Patient_advocacy) involves protecting and supporting the [rights of the client](https://en.wikipedia.org/wiki/Patients%27_rights).** You educate, you explain, and then—even if it breaks your heart—you defend their right to say "no."
...
Do not mistake this for a list of polite suggestions. **The Code of Ethics for Nurses provides a non-negotiable framework for ethical nursing practice.** It is the blueprint of our [profession](https://en.wikipedia.org/wiki/Profession). Let's look closely at the vital provisions you must integrate into your daily practice:
...
## The [Algorithmic](https://en.wikipedia.org/wiki/Algorithm) Approach: Making Ethical Decisions

When you are staring down a complex ethical dilemma, you can't just guess. You need a method. Just like the [nursing process](https://en.wikipedia.org/wiki/Nursing_process) (ADPIE), ethical [problem-solving](https://en.wikipedia.org/wiki/Problem_solving) is systematic.

1.  **Assess:** **The first step in the ethical [decision-making](https://en.wikipedia.org/wiki/Decision-making) process is assessing the situation to determine if an ethical dilemma exists.** Are two ethical principles actually at odds? 
2.  **Gather:** Once a dilemma is confirmed, **the ethical decision-making process requires gathering all [factual data](https://en.wikipedia.org/wiki/Fact) relevant to the ethical dilemma.** You need the patient's exact wishes, the [medical prognosis](https://en.wikipedia.org/wiki/Prognosis), the legal constraints, and the family dynamics. You cannot solve an equation with missing [variables](https://en.wikipedia.org/wiki/Variable_%28mathematics%29).
3.  **Identify:** Next, **the ethical decision-making process requires identifying all possible options for resolving the dilemma.** [Brainstorm](https://en.wikipedia.org/wiki/Brainstorming) everything, even the uncomfortable options. 

### Calling for Backup: The [Chain of Command](https://en.wikipedia.org/wiki/Chain_of_command) & The [Think Tank](https://en.wikipedia.org/wiki/Think_tank)
Sometimes, despite your best problem-solving, the dilemma remains paralyzed. When this happens, you must escalate. **Nurses must use the facility's chain of command to report unresolved ethical dilemmas affecting client care.** 

Where do you start? **The [charge nurse](https://en.wikipedia.org/wiki/Charge_nurse) or [nurse manager](https://en.wikipedia.org/wiki/Nursing_management) is typically the first link in the chain of command for reporting ethical dilemmas.** 

If the leadership team is still deadlocked, we pull in the heavy [artillery](https://en.wikipedia.org/wiki/Artillery). Did you know that **nurses can directly request an [ethics committee](https://en.wikipedia.org/wiki/Ethics_committee) consultation in most healthcare facilities**? You don't need a [doctor's](https://en.wikipedia.org/wiki/Physician) order to sound the alarm on an ethical crisis.

So, who are these people? 
*   **An institutional ethics committee is a [multidisciplinary](https://en.wikipedia.org/wiki/Multidisciplinarity) group.** It includes doctors, nurses, [chaplains](https://en.wikipedia.org/wiki/Chaplain), [legal experts](https://en.wikipedia.org/wiki/Lawyer), and community members. 
*   Their job is specific: **An institutional ethics committee addresses ethical dilemmas in a healthcare facility.**
*   They work by advising: **Institutional ethics committees provide advisory consultations for complex ethical healthcare cases.**

But here is a critical distinction you must understand for the [NCLEX](https://en.wikipedia.org/wiki/National_Council_Licensure_Examination): The committee is a *guide*, not a *[judge](https://en.wikipedia.org/wiki/Judge)*. **Institutional ethics committees lack the authority to make final medical decisions for a client.** Because they cannot write [medical orders](https://en.wikipedia.org/wiki/Medical_prescription), **institutional ethics committees offer recommendations rather than directives.** 

---

## The Aftermath: Evaluation and The Weight of Moral Distress

You identified the dilemma. You escalated it. An intervention was chosen. How do we measure if we succeeded? 

In [clinical care](https://en.wikipedia.org/wiki/Clinic), you check a [blood pressure](https://en.wikipedia.org/wiki/Blood_pressure) to see if the [antihypertensive](https://en.wikipedia.org/wiki/Antihypertensive_drug) worked. In ethics, **evaluating an ethical intervention requires comparing the actual client outcome to the expected ethical outcome.** 

How do we know we won? It has nothing to do with whether the patient survived or not. 
*   **A successful ethical intervention maintains the client's dignity.**
