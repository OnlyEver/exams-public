...
Let's look at how we measure the music of the mind and how we diagnose the dissonance.
...
## 2. The Cognitive Hardware Failures: [Delirium](https://en.wikipedia.org/wiki/Delirium) vs. [Dementia](https://en.wikipedia.org/wiki/Dementia)
...
> **Positive symptoms of schizophrenia** represent pathological psychological *additions* to normal baseline behavior. Things are there that shouldn't be.
...
Next, let's look at perceptual errors. You must know the difference between an [illusion](https://en.wikipedia.org/wiki/Illusion) and a [hallucination](https://en.wikipedia.org/wiki/Hallucination)! 
...
## 4. [Mood](https://en.wikipedia.org/wiki/Mood_%28psychology%29) and [Anxiety Disorders](https://en.wikipedia.org/wiki/Anxiety_disorder): The Extremes of Emotion
...
## 5. [Eating Disorders](https://en.wikipedia.org/wiki/Eating_disorder): The Illusion of Control
...
## 6. The Psychological Shields: [Defense Mechanisms](https://en.wikipedia.org/wiki/Defence_mechanism)
...
## 7. [Personality Disorders](https://en.wikipedia.org/wiki/Personality_disorder): The Faulty Foundations

When maladaptive behavioral traits become rigidly locked into a person's character, we look at [Personality Disorders](https://en.wikipedia.org/wiki/Personality_disorder), which are grouped into three distinct "Clusters":
...
## 8. Healing the Mind: Therapies and Modalities

Now that we know how the system breaks, how do we fix it? We use targeted therapies.
