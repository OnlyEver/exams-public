...
Before we can teach a client anything, we must understand the golden rule of behavioral physics: **Assessing a client's readiness to learn is essential before initiating education on behavior change.** If you try to teach a wall, you'll just get a headache. And to get clients to lower their walls, you must control the climate of the room. **Establishing a non-judgmental therapeutic environment encourages clients to disclose high-risk lifestyle habits.** You must be a safe harbor, an entirely neutral observer of the data, so they feel safe being honest with you.

### The Transtheoretical Model of Change
How do human beings actually change? It’s almost never a sudden light switch; it’s a staircase. **The Transtheoretical Model of Change outlines stages a client progresses through when modifying high-risk behaviors.** You have to know exactly which step of the staircase your client is standing on.

| Stage | The Reality of the Client |
| :--- | :--- |
| **Precontemplation** | The client is sitting at the bottom of the stairs. This stage **involves no intention to alter the high-risk behavior in the near future.** They simply do not view their behavior as a problem. |
| **Contemplation** | They look up at the stairs. The **Contemplation stage of behavior change is characterized by the client recognizing a behavior problem.** Crucially, **clients in the Contemplation stage intend to change the high-risk behavior within the next six months.** They are thinking about it, but haven't acted yet. |
| **Preparation** | They put their hand on the railing. **The Preparation stage involves the client taking small steps toward behavior change**, like looking up a gym membership or buying nicotine patches. |
| **Action** | They are climbing! **The Action stage requires active modification of behavior or environment to overcome a problem.** This is the hardest work. |
| **Maintenance** | They stay at the top. **The Maintenance stage involves sustained action to prevent relapse of the high-risk behavior.** It's about building long-term resilience. |

### The Art of Motivational Interviewing
To help a client move up these stairs, we use a brilliant technique called motivational interviewing. If you tell a client exactly what to do, human nature dictates they will resist. Instead, **motivational interviewing relies on open-ended questions to elicit the client's own reasons for change.** You hold up a mirror. 

By avoiding yes/no questions and letting them talk, **motivational interviewing helps clients explore personal ambivalence regarding behavior change.** We want *them* to realize their habits are conflicting with their life goals.
...
1. **The AUDIT tool assesses alcohol consumption patterns to identify harmful drinking behaviors.** It looks at the big picture of a client's drinking habits and the harm it causes.
2. For a rapid, incisive look into dependence, we use CAGE. **The CAGE questionnaire is a widely used screening tool for detecting alcohol dependence.** 

Let's break down this acronym, because it's brilliantly simple:
...
## Part IV: Into the Deep End (Opioids, IV Drugs, and Harm Reduction)
...
## Part V: Shielding the Body (Sexual Health and Skin)
